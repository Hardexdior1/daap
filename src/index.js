...
const sumOfOddNumbers = (firstNum, secondNum) => {
  const arr = [];
...
async function handle_advance(data) {
  ...
  const result = sumOfOddNumbers(firstNumber, secondNumber);
...
async function handle_inspect(data) {
  ...
  const responseObject = "Inspect route not implemented for sum of odd numbers";
